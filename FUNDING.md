...
- **Open Collective**: Donate through [Open Collective](https://opencollective.com/dndhub) to join our community of backers and sponsors. This platform supports transparent tracking of contributions and expenses.
...
- Participating in discussions on [GitHub Discussions](https://github.com/dndhubs/taxonomy/discussions).
- Sharing the project with your network to grow our community.

Thank you for supporting `@dndhubs/taxonomy` and helping us build a global standard for taxonomy classification, managed by DNDHUBS LIMITED (`https://dndhubs.com`)!