 ...
 *
 */
export type ErrorTypeTaxonomy = CoreErrorType | CustomErrorType;
export type CoreErrorType = 'Error'| 'TypeError' | 'SyntaxError' | 'ReferenceError' | 'RangeError' | 'EvalError' | 'URIError' | 'AggregateError';
export type CustomErrorType = string & { __type?: 'CustomErrorType' };